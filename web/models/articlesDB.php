...
function getAllArticles(): array {
    return getConnection()->query("SELECT article_id articleId, account_id accountId, title, description, 
               DATE(created_date) createdDate, DATE(modified_date) modifiedDate FROM articles")->fetchAll();
}
