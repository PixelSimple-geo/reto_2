        ...
        <?php endif; ?>
            <form method="POST">
                ...
                <?php if (!empty($description)): ?>
                    <textarea id="description" name="description" rows="4" required minlength="1" maxlength="1500"
                            title="Ingresa entre 1 y 500 caracteres. Puedes usar letras, números caracteres y '_'"><?= $description ?></textarea>
                <?php else: ?>
                    <textarea id="description" name="description" rows="4" required minlength="1" maxlength="500"
                            title="Ingresa entre 1 y 500 caracteres. Puedes usar letras, números caracteres y '_'"></textarea>
                <?php endif; ?>
